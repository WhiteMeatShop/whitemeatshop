    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-wm-border">
              <h2 className="text-xl font-medium text-black">{title}</h2>
              <button
                onClick={onClose}
                className="material-icons text-wm-gray hover:text-wm-error transition-colors cursor-pointer"
              >
                close
              </button>
            </div>
